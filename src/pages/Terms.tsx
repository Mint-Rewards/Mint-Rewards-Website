...
import { contactDetails, termsLastUpdated, termsSections } from "../constants";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#1D558E] via-[#3EBAB9] to-[#8CE4B5] py-20 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Welcome to Mint Rewards. By creating an account or using our
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{contactDetails.termsEmail}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm text-white/70">In-App</p>
